 ...
 */
class ComponentbuilderViewNew_view extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		if ($this->refid || $this->ref)
		{
			if ($this->canDo->get('core.create') && $isNew)
			{
				...
				JToolBarHelper::save('new_view.save', 'JTOOLBAR_SAVE');
			}
			...
			if ($isNew)
			{
				...
				JToolBarHelper::cancel('new_view.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				// We can close it.
				JToolBarHelper::cancel('new_view.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		else
		{
			if ($isNew)
			{
				...
				{
					JToolBarHelper::apply('new_view.apply', 'JTOOLBAR_APPLY');
					JToolBarHelper::save('new_view.save', 'JTOOLBAR_SAVE');
					JToolBarHelper::custom('new_view.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				JToolBarHelper::cancel('new_view.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				...
				$canVersion = ($this->canDo->get('core.version') && $this->canDo->get('new_view.version'));
				if ($this->state->params->get('save_history', 1) && $this->canDo->get('core.edit') && $canVersion)
				{
					JToolbarHelper::versions('com_componentbuilder.new_view', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
					JToolBarHelper::custom('new_view.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				JToolBarHelper::cancel('new_view.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$help_url = ComponentbuilderHelper::getHelpUrl('new_view');
	...
	protected function setDocument()
	{
		...
		$document->addScript(JURI::root() . "administrator/components/com_componentbuilder/views/new_view/submitbutton.js"); 
