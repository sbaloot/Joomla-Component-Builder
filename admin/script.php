...
class com_componentbuilderInstallerScript
{
	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'install')
		{
			...
			$admin_view->content_history_options = '{"formFile": "administrator/components/com_componentbuilder/models/forms/admin_view.xml","hideFields": ["asset_id","checked_out","checked_out_time","version","not_required"],"ignoreChanges": ["modified_by","modified","checked_out","checked_out_time","version","hits"],"convertToInt": ["published","ordering","add_php_getitems","type","not_required","add_php_document","add_php_allowedit","add_sql","add_php_postsavehook","add_php_batchcopy","add_fadein","add_php_getitem","add_php_getitems_after_all","add_custom_import","add_css_view","add_css_views","add_javascript_view_file","add_php_batchmove","add_php_before_publish","add_javascript_view_footer","add_php_after_publish","add_php_before_delete","add_javascript_views_file","add_php_after_delete","add_javascript_views_footer","add_custom_button","source","add_php_ajax","add_php_getlistquery","add_php_save"],"displayLookup": [{"sourceColumn": "created_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"},{"sourceColumn": "access","targetTable": "#__viewlevels","targetColumn": "id","displayColumn": "title"},{"sourceColumn": "modified_by","targetTable": "#__users","targetColumn": "id","displayColumn": "name"}]}';
		...
		if ($type == 'update')
		{
			...
			echo '<a target="_blank" href="http://vdm.bz/component-builder" title="Component Builder">
				...
				<h3>Upgrade to Version 2.3.5 Was Successful! Let us know if anything is not working as expected.</h3>';
		}
	}
}
